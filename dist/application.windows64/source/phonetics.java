...
public class phonetics extends PApplet {
...
final double OVERLAP_FACTOR = 0.8f;
final int LETTER_SIZE = 50;
final int MARGIN = 50;

PFont f;
float[] speed = {1.5f, -1.5f};
...
class Timeline {
  ...
  public void showTimelineLetters() {
  ...
  public ArrayList<Letter> sortedLetters(ArrayList<Letter> letters) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--stop-color=#cccccc", "phonetics" };
    if (passedArgs != null) {
